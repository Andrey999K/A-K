...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июл 12 2022 г., 18:30
...
--
ALTER TABLE `answers_texts`
  MODIFY `id_answer_text` int(3) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7037;
...
--
ALTER TABLE `questions_texts`
  MODIFY `id_question_text` int(3) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7013;

--
-- AUTO_INCREMENT для таблицы `test_results`
--
ALTER TABLE `test_results`
  MODIFY `id_results` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
