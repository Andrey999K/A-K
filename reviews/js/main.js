document.addEventListener("DOMContentLoaded", ()=>{
    ...
    function sliderOn(event) {
        ...
        event.target.classList.contains('card-review__video-play-icon')) {
        ...
        setTimeout(() => {
            ...
            if (reviewData['type_file'] === 'image') {
                fileReview = createElement('img', 'card-review__image card-review__content',
                    {'src': `./img/screens/${reviewData['id_review'] + "_" + reviewData['name_file']}`, 'alt': 'review screen'});
            } else {
                fileReview = createElement('video', 'card-review__video card-review__content',
                    {'src': `./video/${reviewData['id_review'] + "_" + reviewData['name_file']}`});
