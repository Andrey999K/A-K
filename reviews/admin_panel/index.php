...
if ($_SESSION['login'] && $_SESSION['password']) {
    ...
    $reviewCategories = $connection->query("SELECT * FROM reviews_categories ORDER BY position_category")->fetchAll();
    $reviewsData = $connection->query("SELECT * FROM reviews ORDER BY id_subcategory, position_review")->fetchAll();
    ...
    foreach ($reviewsData as $reviewData) {
        ...
        array_push($reviews[$reviewData['id_subcategory']],
            array(
                ...
                'name_file' => $reviewData['name_file'],
        ...
        <section class="section categories">
            <div class="container">
                ...
                <div class="section__content categories__content list-content hidden">
                    ...
                    <ul class="section__list categories__list list-order-editable">
        ...
        <section class="section subcategories">
            <div class="container">
                ...
                <div class="section__content subcategories__content hidden">
                    <ul class="section__list subcategories__list">
                        <?php foreach ($reviewCategories as $category) { ?>
                                    ...
                                    if (array_key_exists($category['name_category'], $reviewSubcategories)) {
                                        foreach ($reviewSubcategories[$category['name_category']] as $subcategory) { ?>
                                            <li class="section__item subcategory item-edit-order" id-subcategory="<?= $subcategory['id'] ?>"
                                                ...
                                                <div class="section__item-name-container item-name edit-text-container">
                                                    <span class="section__item-name text-editable"><?= $subcategory['name'] ?></span>
        ...
        <section class="section reviews">
            <div class="container">
                ...
                <div class="section__content reviews__content hidden">
                    <ul class="section__list reviews__list">
                        <?php foreach ($reviewSubcategories as $category => $subcategories) {
                            foreach ($subcategories as $subcategory) { ?>
                            <li class="section__item">
                                <div class="section__item-top">
                                    <h2 class="section__item-name"><?= $subcategory['name'] ?></h2>
                                    ...
                                    <?php if (array_key_exists($subcategory['id'], $reviews)) {
                                        foreach ($reviews[$subcategory['id']] as $review) { ?>
                                           <div class="review-card item-edit-order" item-id="<?= $review['id_review'] ?>"
                                                ...
                                                <img class="review-card__image" src="../img/screens/<?= $review['id_review'] . '_' . $review['name_file'] ?>" alt="review screen" draggable="false">
                                                <?php } else { ?>
                                                <video class="review-card__video" src="../video/<?= $review['id_review'] . '_' . $review['name_file'] ?>"></video>
                                                <?php } ?>
                                               <button class="review-card-button review-card__button-paint button-paint">
                                                ...
                                                <button class="review-card-button review-card__button-delete button-delete button-delete-review" id-review="<?= $review['id_review'] ?>" file-review="<?= $review['id_review'] . '_' . $review['name_file'] ?>">
                ...
                <div class="section__content admins__content hidden">
                    <ul class="section__list admins__list">
                        ...
                        <li class="section__item">
                            ...
                            <button class="section__button-arrow category__item button-delete-category" id="<?= $admin['id_admin'] ?>">Удалить</button>
                        </li>
                        <?php } ?>
                    </ul>
